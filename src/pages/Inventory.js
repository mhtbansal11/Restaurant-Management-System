...
const Inventory = () => {
    ...
    return (
      <Container className="d-flex justify-content-center align-items-center" style={{ minHeight: '400px' }}>
        <div className="text-center">
          ...
          <p className="mt-3 text-muted fw-bold">Audit in progress...</p>
        </div>
      </Container>
    );
  }
  ...
  return (
    <div className="inventory-page-premium">
      <div className="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3 page-header-glass p-3 shadow-sm">
        ...
        <div className="d-flex gap-2 flex-wrap align-items-center">
          ...
          <Form.Select 
            ...
            className="rounded-pill px-4 border-0 bg-glass-inner w-auto"
          >
            {categories.map(cat => (
      ...
      {aiInsights.length > 0 && (
        <div className="ai-reorder-section mb-4">
          <div className="d-flex align-items-center mb-3 px-2">
            <span className="me-2 ai-sparkle">✨</span>
            <h5 className="mb-0 fw-bold">AI Smart Reorder Suggestions</h5>
          </div>
          <Row className="g-3">
            {aiInsights.map((insight, idx) => (
              <Col key={idx} md={6} lg={4}>
                <div className={`ai-insight-card elevation-${insight.priority}`}>
                  <div className="ai-insight-content">
                    <div className="fw-bold fs-5">{insight.name}</div>
                    <div className="small opacity-75">{insight.suggestion}</div>
                  </div>
                  <Button variant="light" size="sm" className="rounded-pill px-3 fw-bold" disabled={!canManageInventory}>
                    REPLENISH
                  </Button>
                </div>
              </Col>
